...
// Source: github.com/rancher-teja/lasso/pkg/client (interfaces: SharedClientFactory)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package client -destination ./mocks_test.go github.com/rancher-teja/lasso/pkg/client SharedClientFactory
//
...
func (m *MockSharedClientFactory) ForKind(gvk schema.GroupVersionKind) (*Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockSharedClientFactory) ForResource(gvr schema.GroupVersionResource, namespaced bool) (*Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockSharedClientFactory) ForResourceKind(gvr schema.GroupVersionResource, kind string, namespaced bool) *Client {
	m.ctrl.T.Helper()
